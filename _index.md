...
- [Salt — Dosage, Frequency, and Conditions](./source-extracts/Salt_Dosage_and_Conditions.md) (what the guidelines actually specify for salt across three layers — classical Āyurveda (qualitative, seasonal), contemporary Āyurvedic practice (gram doses: ~1.5–2 g/day saindhava, harm above ~4 g), and the Book of Sol's stricter chloride line — with the indication/contraindication conditions, the seasonal modulation, and the note that the eye-good saindhava is itself ~NaCl)
