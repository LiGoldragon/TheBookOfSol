...
- [Honey and Fire](./ayurveda/Honey_and_Fire.md)
...
- [Salt — Dosage, Frequency, and Conditions](./source-extracts/Salt_Dosage_and_Conditions.md) (the salt guidelines read against the no-salt benchmark — the Yanomami's ~1 mmol sodium/day with no hypertension and flat lifelong blood pressure; classical Āyurveda (qualitative, seasonal), the contemporary Āyurvedic gram doses shown to run 25–35× that benchmark and thus already in the harmful range, and the Book of Sol's none-added line; with indications, contraindications, and the note that the eye-good saindhava is itself ~NaCl)
...
- [Raw Veganism and Fruitarianism — the Harm in the Clinical Record](./source-extracts/Raw_Vegan_Fruitarian_Harm.md) (verified modern clinical and forensic literature — the Giessen Raw Food Study on weight loss / amenorrhea / dental erosion, the bone-mass study, the forensic infant cases — each clinical outcome mapped to the *dhātu-kṣaya* / *ojakṣaya* / *vāta* doctrine that named the mechanism first; micronutrient-deficiency arguments deliberately excluded)
- [The Raw-Vegan Staples — Classical Warnings](./source-extracts/Raw_Vegan_Staples_Warnings.md) (the classical verdict on the raw plate's load-bearing foods that the other extracts leave uncovered — raw **nuts** (*guru*, kapha-pitta-aggravating, Caraka Sū. 27), raw **seeds** (*tila* and its malaise-causing paste), and **sprouted grains and legumes** (*guru*, strength-reducing) — with the *na hy apakvād rasādayaḥ* principle and a food-by-food synthesis of the raw-vegan plate)
- [Cooking and Agni — primary-source extracts](./source-extracts/Cooking_and_Agni.md) (Ayurvedic, Yogic, and Vedic / Upaniṣadic passages refuting the modern "cooking kills life force" claim — *agni* as transformer, *anna-rasa-prāṇa* chain, body as cooking vessel, raw input as *āma*-producer)
- [Agni and Tapas — primary-source extracts](./source-extracts/Agni_and_Tapas.md) (Vedic *Agni* hymns, *tapas* in the Yoga Sūtras and *Gītā*, the Ayurvedic *pitta* dialectic of excess and deficiency, cross-tradition fire deities — Hestia, Hephaestus, Prometheus, Vesta, Atar, Yahweh as fire)
