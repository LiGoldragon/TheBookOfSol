# Witnesses Against Salt: The Greek Record

## *Homer, Plutarch, Pythagoras, and the Egyptian priesthood through Greek eyes*
...
The prophecy casts the saltless people as the apotheosis of peace — the terminal destination of the hero's wandering. In the geographical imagination of archaic Greece, the salt-free diet marks the land where the sea's violence cannot reach, where the brine of ocean does not season the bread. It is the land at which Odysseus's trials finally end. The symbolic register is precise: salt is sea, sea is storm, storm is trouble. The inland people, who do not taste salt, live beyond the reach of the storm.

The prophecy is repeated twice in the epic — XI.121–134 (Teiresias in Hades) and XXIII.267–284 (Odysseus to Penelope in their marriage-bed) — indicating that Homer treats the motif as structurally essential. The hero's journey does not end at Ithaca. It ends among the saltless.

## Plutarch — The Priests of Isis

Plutarch's two works preserve the memory of the Egyptian priestly abstention from salt with the greatest detail of any Greco-Roman source. The testimony is preserved in two registers: the theological register of *De Iside et Osiride* (*Isis and Osiris*) and the dialectical register of the *Quaestiones Convivales* (*Table Talk*).
...
Plutarch, a Greek observer writing under Roman rule about an Egyptian priestly tradition whose memory he received second- and third-hand, records the same three reasons for salt-abstention that the Sanskrit tradition gives for the *aluṇa-vrata*: appetite-inflammation, continence-disturbance, incompatibility with austerity. The convergence across Mediterranean and Indian traditions — neither aware of the other — is itself the strongest possible testimony that the underlying observations are empirical, not cultural.
...
## The Hippocratic and Galenic Registers

The medical tradition — Hippocrates and Galen — does not condemn salt categorically, but records its dangers in specific pathological contexts. Hippocrates' *Regimen* notes that salty foods produce thirst and retention of fluids. Galen's *On the Properties of Foodstuffs* classifies excessive salt as drying, inflammatory, and productive of skin disease — the same list that Vāgbhaṭa's *Aṣṭāṅga Hṛdaya* gives, independently, in the Indian corpus. The overlap of observations across medical traditions that had no mutual contact is itself evidence.

## The Greek Verdict

The Greek tradition did not prohibit salt the way the Indian dharmic tradition did. It preserved the exception with more ambivalence — the saltcellar remained on the Greek table, salt was sacred, salt bonded host and guest. And yet within that ambivalence, the Greek tradition also preserved, as carefully as any, the three witnesses against salt's place in the diet of the person aspiring to clarity:

1. **Homer**, who sets the saltless people at the terminus of heroic striving.
2. **Plutarch**, who transcribes the Egyptian priestly abstention with its reasons.
3. **Pythagoras**, whose contemplative discipline also removed salt.

All three preserve the same pattern the Indian dharmic tradition preserved. The rest of the Greek culture ate salt, as the rest of the Indian culture did. The memory of the disciplined exception — of those for whom the ordinary rule was not enough — is what Homer, Plutarch, and the Pythagorean tradition preserved in Greek.

### Sources

The *Odyssey* is given in the Monro–Allen or West critical Greek texts; the English renderings here are literal translations of the Greek. Plutarch's *De Iside et Osiride* and *Quaestiones Convivales* are cited by the Stephanus pagination of the Moralia; the Loeb Classical Library editions are translated by F. C. Babbitt (Moralia V) and P. H. De Lacy (Moralia VIII). Diogenes Laertius is cited from the Hicks translation (Loeb, two volumes). Iamblichus's *Life of Pythagoras* is available in the Thomas Taylor translation and in more recent scholarly editions (Clark, Dillon, Finamore). For Galen on salt, see *On the Properties of Foodstuffs* (Powell translation, Cambridge).

*See also the companion files: [Witnesses_Against_Salt_Hebrew](./Witnesses_Against_Salt_Hebrew.md) for the parallel witness in scripture, and [Witnesses_Against_Salt_Chinese](./Witnesses_Against_Salt_Chinese.md) for the Han-dynasty medical register.*
