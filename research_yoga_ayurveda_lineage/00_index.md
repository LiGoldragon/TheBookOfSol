# Yoga & Āyurveda — Shared Lineage Research
...
- Quote-heavy. The point of this directory is raw material to compose from.
- Every quote: Sanskrit (when available, in IAST), English translation, precise citation (text, chapter, verse).
- Primary sources first, scholarship second.
- No horizontal-rule separators (`---`). Use headings.
