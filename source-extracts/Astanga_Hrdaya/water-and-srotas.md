...
Read Sū. 5 together with the *srotāṃsi* doctrine and the *dhātu*-formation doctrine, and the picture is complete:

1. **Default**: drink less, off-season especially. (Sū. 5.13–14)
2. **Trigger**: when natural thirst arises, satisfy it with cold water. (Sū. 4.10)
3. **Pathology**: chronic thirst is a vitiation of the *ambuvaha-srotas*, produced by undigested food and dry/wrong inputs. (AS Śā. 6)
4. **Repair**: rebuild the rasa-dhātu by feeding agni properly with cooked, unctuous, sweet anna. (AH Śā. 3.50–54, HYP 1.58)

The body that does not want water is the body whose channels are clean and whose plasma is being built from anna, not from water.
